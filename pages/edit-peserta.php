...
<div class="container">
    ...
    <input type="hidden" name="id_siswa" value="<?php echo $isi['id_siswa'];?>">
        ...
        <button type="button" class="btn btn-success"><a style="text-decoration:none;color:white;"href="index_admin.php?p=peserta2">Kembali</a></button>
    </form>
</div>